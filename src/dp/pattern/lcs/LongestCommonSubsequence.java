...
class LongestCommonSubsequence {
    ...
    private int solveR(char[] a, char[] b, int m, int n) {
        ...
        if (a[m - 1] == b[n - 1]) return 1 + solveR(a, b, m - 1, n - 1);
        else return Integer.max(solveR(a, b, m - 1, n), solveR(a, b, m, n - 1));
    }
    ...
    private int solveM(char[] a, char[] b, int m, int n, int[][] dp) {
        ...
        if (a[m - 1] == b[n - 1]) return dp[m][n] = 1 + solveM(a, b, m - 1, n - 1, dp);
        else return dp[m][n] = Integer.max(solveM(a, b, m - 1, n, dp), solveM(a, b, m, n - 1, dp));
    }
